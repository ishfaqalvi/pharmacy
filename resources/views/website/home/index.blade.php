...
<section class="product-list pbc-5 pb-4 pt-5 bg-light">
    <div class="container">
        <h6 class="mt-1 mb-0 float-right"><a href="{{ route('product.index',['type' => 'Featured']) }}">View All Items</a></h6>
...
<section class="product-list pbc-5 pb-4 pt-5 bg-light">
    <div class="container">
        <h6 class="mt-1 mb-0 float-right"><a href="{{ route('product.index',['type' => 'Frequently']) }}">View All Items</a></h6>
...
<section class="product-list pbc-5 pb-4 pt-5 bg-light">
    <div class="container">
        <h6 class="mt-1 mb-0 float-right"><a href="{{ route('product.index',['type' => 'Wellness']) }}">View All Items</a></h6>
...
<section class="product-list pbc-5 pb-4 pt-5 bg-light">
    <div class="container">
        <h6 class="mt-1 mb-0 float-right"><a href="{{ route('product.index',['type' => 'Men & Woman']) }}">View All Items</a></h6>
