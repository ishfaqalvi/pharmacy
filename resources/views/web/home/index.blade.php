            ...
            <div class="col-6 col-md-3">
               <div class="card list-item bg-white rounded overflow-hidden position-relative shadow-sm">
                  ...
                  <a  href="{{ route('product.show', $product->id)}}">
                     ...
                     <img src="{{ $product->thumbnail }}" class="card-img-top" alt="..."></a>
                  <div class="card-body">
                     <h6 class="card-title mb-1">{{ $price->title }}</h6>
                     <div class="stars-rating"><i class="icofont icofont-star active"></i><i
                           class="icofont icofont-star active"></i><i class="icofont icofont-star active"></i>
                     </div>
                     <p class="mb-0 text-dark">$135.00 <span class="text-black-50"><del> {{ $price->new_price }}</del></span></p>
                  </div>
               </div>
            </div>
