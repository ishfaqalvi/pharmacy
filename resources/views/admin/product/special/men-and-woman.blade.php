...
<div class="col-sm-12">
    <div class="card collapse {{ !is_null($userRequest) ? 'show' : ''}}" id="filters">
        <div class="card-body">
            <form action="{{route('products.special.men&womanFilter')}}" method="post">
                @csrf
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Men and Woman Product</h5>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('products.special.destroy',$product->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="type" value="Men & Woman">
