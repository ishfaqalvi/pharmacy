...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('Create') }} Order Detail</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('order-details.store') }}" class="validate" role="form" enctype="multipart/form-data">
                @csrf
