...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">{{ __('Edit ') }} Composition </h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('compositions.update', $composition->id) }}" class="validate" role="form" enctype="multipart/form-data">
                @csrf
                {{ method_field('PATCH') }}
